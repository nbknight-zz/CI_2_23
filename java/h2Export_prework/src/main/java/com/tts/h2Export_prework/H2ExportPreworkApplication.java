package com.tts.h2Export_prework;
...
import com.tts.h2Export_prework.repository.CustomerRepository;

@SpringBootApplication
public class H2ExportPreworkApplication {
	private static final Logger log = LoggerFactory.getLogger(H2ExportPreworkApplication.class);
	public static void main(String[] args) {
		SpringApplication.run(H2ExportPreworkApplication.class, args);
	}
	@Bean
